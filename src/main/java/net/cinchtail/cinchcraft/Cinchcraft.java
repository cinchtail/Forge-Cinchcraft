...
public class Cinchcraft
{
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTab() == ModCreativeModeTabs.CINCHCRAFT_BLOCK_TAB.get()) {
            ...
            event.accept(ModBlocks.CRACKED_END_STONE_BRICK_STAIRS);
            event.accept(ModBlocks.CRACKED_END_STONE_BRICK_SLAB);
            event.accept(ModBlocks.CRACKED_END_STONE_BRICK_WALL);
            ...
            event.accept(ModItems.AZALEA_LOG);
            event.accept(ModItems.AZALEA_WOOD);
            event.accept(ModItems.STRIPPED_AZALEA_LOG);
            event.accept(ModItems.STRIPPED_AZALEA_WOOD);
            event.accept(ModItems.AZALEA_PLANKS);
